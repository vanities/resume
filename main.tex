...
{\color{Periwinkle} \section{\textbf{Skills}}}
	...
	\resumeSubItem{Frameworks}{~~~Django, Flask, NodeJS, React, NextJS, SwiftUI}
	\resumeSubItem{Tools}{~~~~~~~~~~~~~Docker, Terraform, Pivotal Tracker, GIT, PostgreSQL, Fastlane, Hardhat, Redux}
	\resumeSubItem{Platforms}{~~~~~~Mac, Linux, Web, iOS, AWS, GCP, Firebase, Github, Datadog, Sentry, Code Climate, CircleCI, Vercel}
...
{\color{ForestGreen} \section{\textbf{Experience}}}
  ...
  \resumeSubheading{\underline{\href{http://ford.com}{Ford - Experience Design}}}{Remote}
    ...
    \resumeItemListStart
          ...
          {Demonstrated technical expertise and adaptability by developing multiple prototypes for the BlueCruise Audio Tour Guide Experience iOS app and the Apple Vision Pro BlueCruise experience, showcasing proficiency in cutting-edge technologies like React, React Native, iOS, CarPlay, Android, and Android Auto.}
