...
\hspace{0.5cm}\textbf{Frameworks} & Django (7y), Postgres (6y), React (6y), NodeJS (5y), Flask (4y), SwiftUI (4y), NextJS (3y) \\
\hspace{0.5cm}\textbf{Tools} & git (10y), Docker (6y), Pivotal Tracker (6y), JIRA (5y), Redis (5y), Terraform (5y), Redux (4y) \\
