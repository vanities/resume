...
{\color{ForestGreen} \section{\textbf{Experience}}}
  ...
  \resumeSubheading{\underline{\href{http://open3.com}{Open3 - Qualified Digital Art Platform}}}{Remote}
    ...
    \resumeItemListStart
          ...
          {Developed a React Website, Django Backend, and a sercure Solidity Smart Contract template in 3 months, attracting over 17,000 verified users and hosting 68 partners and their projects, including renowned brands like Liquid Death.}
          \resumeItem{Leadership}
